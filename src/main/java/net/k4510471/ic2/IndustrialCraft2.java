...
@Mod(IndustrialCraft2.MOD_ID)
public class IndustrialCraft2 {
    public static final String MOD_ID = "industrialcraft2";
    private static final Logger LOGGER = LogUtils.getLogger();

    // The constructor for the mod class is the first code that is run when your mod is loaded.
    // FML will recognize some parameter types like IEventBus or ModContainer and pass them in automatically.
    public IndustrialCraft2(IEventBus modEventBus, ModContainer modContainer) {
    ...
    public void onServerStarting(ServerStartingEvent event) {
        LOGGER.info("IC2 onServerStartingEvent");
    }
    ...
    public static class ClientModEvents {
        ...
        public static void onClientSetup(FMLClientSetupEvent event) {
            LOGGER.info("IC2 FMLClientSetupEvent");
        }
    }
}
